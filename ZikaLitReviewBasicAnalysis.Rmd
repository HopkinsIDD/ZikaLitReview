...
Based on the independent MCMC analysis, assuming that the incubation period for Zika
infection follows a log-normal diatribution, we estimate the mean incubation period to be 6.3 days (95% CI: 4.8-8.2). The dispersion is 1.38 (95% CI: 1.2-1.8). Hence 5% of cases will develop symptoms by 3.7 days after infection (95% CI: 2.2-4.9), 25% by 5.1 days (95% CI: 3.7-6.4), 75% by 7.9 days (95% CI: 5.9-11.1) and 95% by 10.7 days (95% CI: 7.4-19.0).
...
#   colnames(vshed.bl.anal) <- c("UID","EL","ER","SL","SR","type")
# 
#   #change the infinite SRs to something really big
#   vshed.bl.anal$SR[is.infinite(vshed.bl.anal$SR)] <- 
#       vshed.bl.anal$ER[is.infinite(vshed.bl.anal$SR)] + 730
# 
#   #now lets fit a gamma distribution to this data using MCMC
#  vshed.fit <- dic.fit(vshed.bl.anal, dist = "W", n.boots = 100)
  #vshed.fit.mcmc <- dic.fit.mcmc(vshed.bl.anal, dist = "G",
...
############A BIT OF A DISASTER, DUES NOT WORK
...
# 
# sero.fit<- dic.fit(tmp, dist = "G", n.boots = 100)
# sero.fit.mcmc <- dic.fit.mcmc(tmp, dist="W")

...
Based on the bootstrap analysis, assuming that the incubation period for Zika
infection follows a log-normal diatribution, we estimate the mean incubation period to be 6.4 days (95% CI: 4.8-8.0). The dispersion is 1.36 (95% CI: 1.0-1.5). Hence 5% of cases will develop symptoms by 3.8 days after infection (95% CI: 2.9-8.0)and 95% by 10.6 days (95% CI: 7.2-13.1).
...
XXXXXXXXXXNOT WORKINGXXXXXXXXXXXX
```{r}
...
for (uid in unique(zika.vshed.bl$UID)) {
 ...
 #change the infinite SRs to something really big
  ...
  vshed.fit <- dic.fit(tmp, dist = "W", n.boots = 100,
                       par1.int=c(1,10), par2.int=c(1, 100))
...
The mean incubation period is 6.0 days (95% CI: 4.6-7.9) with a dispersion of 1.47 (95% CI: 1.24-1.94). 90% of cases will develop symptoms between 3.2 and 11.6 days of infection (95% CIs: 1.8-4.6 and 7.9-18.8).

The mean time to viral clearanace is estimated to be 9.7 days (95% CI: 7.9-13.4), and  we expext 90% of people to clear virus between 3.3 and 18.5 days after infection (95% CIs: 0-5.6 and 12.3-37.2).

The mean time to seroconversion is 8.9 days (95% CI: 6.9-11.4), and we expect 90% of peopld to seroconvert between 3.9 and 14.3 days of infection (95% CIs: 1.6-5.4 and 11.0-19.8).
...
Based on 4 chains, 35,000 interations per chain, assiming that both the time to symptom onset and the time to viral clearance follow a log-normal distribution, we estimate that the mean incubation period is 6.2 days (95% CI: 4.8-8.1) with a dispersion of 1.49 (95% CI: 1.24-1.94). 90% of cases will develop symptoms between 3.3 and 12.3 days of infectoin (95% CIs: 1.9-4.8 and 8.0-20.5).

The mean time to viral cleanace is estimated to be 7.1 days (95% CI: 1.8-12.3) with a dispersiont of 2.47 (95% CI: 1.30-16.1). We expext 90% of people to clear virus between 3 and 54 days after infection (95% CI: 0-7 and 12-280).
